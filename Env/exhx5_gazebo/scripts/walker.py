...
class WFunc:
    """
    Multi-joint walk function for Exhx5    
    """
...
class Walker:
    """
    Class for making Exhx5 walk
    """
    def __init__(self,exhx5):
        self.exhx5=exhx5
        self.running=False
        ...
        self._sub_cmd_vel=rospy.Subscriber(exhx5.ns+"cmd_vel",Twist,self._cb_cmd_vel,queue_size=1)
    ...
    def init_walk(self):
        ...
        if self.get_dist_to_ready()>0.02:                    
            self.exhx5.set_angles_slow(self.ready_pos)        
...
if __name__=="__main__":
    ...
    exhx5=Exhx5()
    rospy.loginfo("Instantiating Exhx5 Walker")
    walker=Walker(exhx5)
 
    rospy.loginfo("Exhx5 Walker Ready")
