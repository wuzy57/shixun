...
#ifndef EXHX5_KINEMATICS_DYNAMICS_H_
#define EXHX5_KINEMATICS_DYNAMICS_H_

#include <vector>
#include <eigen3/Eigen/Eigen>

#include "exhx5_kinematics_dynamics_define.h"
#include "link_data.h"
...
class EXHX5KinematicsDynamics
{

 public:
  EXHX5KinematicsDynamics();
  ~EXHX5KinematicsDynamics();
  EXHX5KinematicsDynamics(TreeSelect2 tree);
  ...
  LinkData *exhx5_link_data_[ ALL_JOINT_ID + 1];
...
#endif /* EXHX5_KINEMATICS_DYNAMICS_H_ */
