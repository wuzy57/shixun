...
#ifndef EXHX5_WALKING_MODULE_H_
#define EXHX5_WALKING_MODULE_H_

#include "exhx5_walking_parameter.h"
...
class WalkingModule : public robotis_framework::MotionModule, public robotis_framework::Singleton<WalkingModule>
{
 ...
 private:
  ...
  EXHX5KinematicsDynamics* exhx5_kd_;
